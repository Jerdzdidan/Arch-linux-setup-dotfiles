...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card period-info-card">
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-0">
            <div class="card h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" id="totalOfficers"><span class="stat-value-loading"></span></div>
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-0">
            <div class="card h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" id="totalDepartments"><span class="stat-value-loading"></span></div>
    ...
    {{-- Grade Distribution + Recent Imports --}}
    <div class="row mb-4">
        ...
        <div class="col-lg-6">
            <div class="card recent-imports-card h-100">
                <div class="card-body">
                    <h6 class="card-title mb-3">
                        <i class="fa-solid fa-file-import me-2"></i>Recent Grade Imports
                    </h6>
                    <div class="table-responsive">
                        <table class="table table-sm" id="recentImportsTable">
                            <thead>
                                <tr>
                                    <th>File</th>
                                    <th>Period</th>
...
<script>
    $(document).ready(function() {
        ...
        $.get("{{ route('admin.dashboard.stats') }}", function(data) {
            ...
            programChart = new Chart(document.getElementById('studentsByProgramChart'), {
                type: 'bar',
                data: {
                    labels: progLabels,
                    datasets: [{
            ...
            yearChart = new Chart(document.getElementById('studentsByYearChart'), {
                type: 'doughnut',
                data: {
                    labels: yearLabels,
                    datasets: [{
            ...
            gradeChart = new Chart(document.getElementById('gradeDistributionChart'), {
                type: 'bar',
                data: {
                    labels: gradeLabels,
                    datasets: [{
            ...
            if (data.recentImports.length === 0) {
                tbody.append('<tr><td colspan="5" class="text-center text-muted py-3">No imports yet</td></tr>');
            } else {
                data.recentImports.forEach(function(imp) {
                    var statusBadge = imp.status === 'committed' ?
                        '<span class="badge bg-label-success">Committed</span>' :
                        '<span class="badge bg-label-warning">' + imp.status + '</span>';
                    tbody.append(
                        '<tr>' +
                        '<td class="text-truncate" style="max-width:120px;" title="' + imp.filename + '">' + imp.filename + '</td>' +
                        '<td>' + imp.academic_period + '</td>' +
