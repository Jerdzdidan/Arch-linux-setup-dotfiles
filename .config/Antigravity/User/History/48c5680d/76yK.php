    ...
    <div class="content-container">
        ...
        <div class="card compose-card mb-4">
            ...
            <div class="card-body p-4">
                <form id="announcement-form">
                    ...
                    {{-- Recipient Type --}}
                    <div class="mb-3">
                        <label for="recipient_type" class="form-label fw-semibold">Send To</label>
                    ...
                    {{-- Filters (shown when Students is selected) --}}
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 fw-semibold"><i class="fa-solid fa-clock-rotate-left me-2"></i>Announcement History</h5>
            </div>
            <div class="card-body">
...
$(document).ready(function() {
    ...
    function toggleFilters() {
        ...
        if (type === 'students') {
            $('#student-filters').slideDown(200);
        } else {
            $('#student-filters').slideUp(200);
            $('#program_id').val('');
            $('#year_level').val('');
        }
    }
